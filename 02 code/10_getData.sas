**********************************************************************************************
 PROGRAM NAME		: Attr files
 PROGRAMMER			: K Wiggins
 DATE OF CREATION	: 08 18 2022
 PROJECT			: Attributed counts
 PURPOSE			: Had data team check NPI's and testing it again
 INPUT FILE(S)		: 
 OUTPUT FILE(S)		: 
...
* global paths, settings  ---------------------------;
  %let path = S:/FHPC/DATA/HCPF_Data_files_SECURE/Kim;
  %let attr = &path/isp/isp_attr;
