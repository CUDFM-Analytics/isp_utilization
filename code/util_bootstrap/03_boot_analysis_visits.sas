...
/*%LET pdftitle = cost_rx;*/
/*%LET dv = cost_rx; */
/*LIBNAME cost_rx "&projRoot\data_boot_processed\cost_rx";*/
%LET pdftitle = visits_tel;
%LET dv = n_tel; /* for fmtsearch libname, */
LIBNAME n_tel "&projRoot\data_boot_processed\visits_tel";
...
/*PROC SQL; SELECT count(distinct bootunit) from datapro._resample_out_1; QUIT; */
