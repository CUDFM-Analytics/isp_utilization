...
libname out "&projRoot\data_boot_processed\visits_ffsbh";
* location of input data to boot (where resampled sets are); 
...
CLASS bootunit 
      ...
      sex(ref='Female') 
      ind_visit_ffsbh(ref='0');
MODEL ind_visit_ffsbh = time int int_imp season1 season2 season3 
...
CLASS bootunit 
      ...
      race(ref='non-Hispanic White/Caucasian') 
      sex(ref='Female') ;
MODEL visits_ffsbh = time int int_imp season1 season2 season3 
                bh_oth17 bh_oth18 bh_oth19 bh_er17 bh_er18 bh_er19 bh_hosp17 bh_hosp18 bh_hosp19
                adj_pd_total_17cat adj_pd_total_18cat adj_pd_total_19cat
